...
const StoreInsights = {
  ...
  register: (Component, rootId, environment) => {
    ...
    const rootBlock = React.createElement(Component, null);
...
const createStore = ({
  ...
  if (appState.hasOwnProperty(storeID)) console.error(ERROR.STORE_NAME_ALREADY_EXISTS(storeID));
  ...
  const StoreDefinition = {
    [storeID]: props => {
      const [store, setStorage] = useReducer((state, newState) => ({
        ...state,
        ...newState
...
export { StoreManager, StoreInsights, createStore };
/*
